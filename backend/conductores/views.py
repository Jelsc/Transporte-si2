...
class ConductorViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated, CanManageConductores]
    filter_backends = [
        DjangoFilterBackend,
    ...
    def estadisticas(self, request):
        ...
        stats = {
            ...
            "por_tipo_licencia": dict(
                queryset.values("tipo_licencia")
                .annotate(count=models.Count("id"))
    ...
    def licencias_vencidas(self, request):
        ...
        conductores = Conductor.objects.filter(
            fecha_venc_licencia__lt=timezone.now().date(), es_activo=True
        )
