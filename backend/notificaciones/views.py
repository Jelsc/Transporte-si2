...
from .models import DispositivoFCM, Notificacion, PreferenciaNotificacion, TipoNotificacion
...
class NotificacionViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def marcar_multiples(self, request):
        ...
        serializer = NotificacionEstadoSerializer(data=request.data, context={'request': request})
        ...
        if serializer.is_valid():
            ...
            return Response({
                'message': f'{count} notificaciones actualizadas',
                'accion': accion
    ...
    try:
        ...
        try:
            ...
            return Response({
                ...
                'notificacion_id': resultado.id if hasattr(resultado, 'id') else 'N/A',
