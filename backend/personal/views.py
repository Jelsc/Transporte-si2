...
from users.permissions import CanManagePersonal, IsOwnerOrAdmin
...
class PersonalViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated, CanManagePersonal]
    filter_backends = [
        DjangoFilterBackend,
    ...
    def perform_update(self, serializer):
        ...
        if not self.request.user.tiene_permiso("gestionar_personal"):
            raise permissions.PermissionDenied(
                "No tienes permisos para actualizar empleados"
            )
...
class DepartamentoViewSet(viewsets.ModelViewSet):
    ...
    def perform_update(self, serializer):
        ...
        if not self.request.user.tiene_permiso("gestionar_personal"):
            raise permissions.PermissionDenied(
                "No tienes permisos para actualizar departamentos"
            )
