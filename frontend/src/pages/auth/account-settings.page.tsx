...
export default function AccountSettings({}: AccountSettingsProps) {
  ...
  const renderEmailSection = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Direcciones de correo electrónico</h2>
        <p className="text-gray-600 mt-2">
          Gestiona las direcciones de correo electrónico asociadas a tu cuenta
        </p>
      </div>
  ...
  const renderPasswordSection = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Cambiar la contraseña</h2>
        <p className="text-gray-600 mt-2">
  ...
  const renderConnectionsSection = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Conexiones de Cuenta</h2>
        <p className="text-gray-600 mt-2">
                ...
                <nav className="space-y-1">
                  ...
                  <div className="border-t pt-2 mt-2">
                    <button 
                      ...
                      disabled={loading}
                      className="w-full text-left px-4 py-3 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                      {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : null}
